...
#define LABEL_KEY_UP "ALLEGRO_KEY_UP"
#define LABEL_KEY_LEFT "ALLEGRO_KEY_LEFT"
#define LABEL_KEY_DOWN "ALLEGRO_KEY_DOWN"
#define LABEL_KEY_RIGHT "ALLEGRO_KEY_RIGHT"
...
load_default_options (void)
{
  ...
  CONFIG_KEY_UP[0] = ALLEGRO_KEY_UP;
  CONFIG_KEY_DOWN[0] = ALLEGRO_KEY_DOWN;
  CONFIG_KEY_LEFT[0] = ALLEGRO_KEY_LEFT;
  CONFIG_KEY_RIGHT[0] = ALLEGRO_KEY_RIGHT;
  CONFIG_TEAM_COLOR[0] = 0;
  CONFIG_CONTROL_TYPE[0] = CONFIG_CONTROL_TYPE_HUMAN;
  LW_MACRO_STRCPY (CONFIG_PLAYER_NAME[0], "Napoleon");

  CONFIG_KEY_UP[1] = ALLEGRO_KEY_I;
  CONFIG_KEY_DOWN[1] = ALLEGRO_KEY_K;
  CONFIG_KEY_LEFT[1] = ALLEGRO_KEY_J;
  CONFIG_KEY_RIGHT[1] = ALLEGRO_KEY_L;
  CONFIG_TEAM_COLOR[1] = 4;
  CONFIG_CONTROL_TYPE[1] = CONFIG_CONTROL_TYPE_OFF;
  LW_MACRO_STRCPY (CONFIG_PLAYER_NAME[1], "Clovis");

  CONFIG_KEY_UP[2] = ALLEGRO_KEY_UP;
  CONFIG_KEY_DOWN[2] = ALLEGRO_KEY_DOWN;
  CONFIG_KEY_LEFT[2] = ALLEGRO_KEY_LEFT;
  CONFIG_KEY_RIGHT[2] = ALLEGRO_KEY_RIGHT;
  CONFIG_TEAM_COLOR[2] = 8;
  CONFIG_CONTROL_TYPE[2] = CONFIG_CONTROL_TYPE_OFF;
  LW_MACRO_STRCPY (CONFIG_PLAYER_NAME[2], "Henri IV");

  CONFIG_KEY_UP[3] = ALLEGRO_KEY_Q;
  CONFIG_KEY_DOWN[3] = ALLEGRO_KEY_A;
  CONFIG_KEY_LEFT[3] = ALLEGRO_KEY_Z;
  CONFIG_KEY_RIGHT[3] = ALLEGRO_KEY_X;
  CONFIG_TEAM_COLOR[3] = 6;
  CONFIG_CONTROL_TYPE[3] = CONFIG_CONTROL_TYPE_OFF;
  LW_MACRO_STRCPY (CONFIG_PLAYER_NAME[3], "Cesar");

  CONFIG_KEY_UP[4] = ALLEGRO_KEY_PAD_8;
  CONFIG_KEY_DOWN[4] = ALLEGRO_KEY_PAD_5;
  CONFIG_KEY_LEFT[4] = ALLEGRO_KEY_PAD_4;
  CONFIG_KEY_RIGHT[4] = ALLEGRO_KEY_PAD_6;
  CONFIG_TEAM_COLOR[4] = 10;
  CONFIG_CONTROL_TYPE[4] = CONFIG_CONTROL_TYPE_OFF;
  LW_MACRO_STRCPY (CONFIG_PLAYER_NAME[4], "Geronimo");

  CONFIG_KEY_UP[5] = ALLEGRO_KEY_MOUSE_UP;
  CONFIG_KEY_DOWN[5] = ALLEGRO_KEY_MOUSE_DOWN;
  CONFIG_KEY_LEFT[5] = ALLEGRO_KEY_MOUSE_LEFT;
  CONFIG_KEY_RIGHT[5] = ALLEGRO_KEY_MOUSE_RIGHT;
