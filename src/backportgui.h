...
/* some dialog procedures */
    ...
    AL_FUNCPTR (void, gui_menu_draw_menu_item,
                (MENU * m, int x, int y, int w, int h, int bar, int sel));
    ...
    AL_FUNC (int, dialog_message,
             (DIALOG * dialog, int msg, int c, int *obj));
