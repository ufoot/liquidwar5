...
lw_langfr_init ()
{
  ...
  LW_LANGFR_DATA[LW_LANG_STRING_POPUP_MEMTROUBLE] =
    "Pas assez de m�moire pour les bitmaps.";
  LW_LANGFR_DATA[LW_LANG_STRING_POPUP_BIGDATA] = "Pas assez de m�moire.";
  LW_LANGFR_DATA[LW_LANG_STRING_POPUP_LOADFAIL] =
    "Impossible de charger le fichier de donn�es. Etes-vous s�r que Liquid War est correctement install�?";
  LW_LANGFR_DATA[LW_LANG_STRING_POPUP_CUSTOMFAIL] =
    "Impossible de charger les fichiers de donn�es utilisateur.";
