...
Source: https://ufoot.org/download/liquidwar/v5/5.7.0/liquidwar5-5.7.0.tar.gz
...
%post
if which install-info; then if test -d %{_prefix}/info; then if test -f %{_prefix}/info/dir; then install-info --info-dir=%{_prefix}/info %{_prefix}/share/info/liquidwar5.info.gz; fi; fi; fi
...
%postun
if which install-info; then if test -d %{_prefix}/info; then if test -f %{_prefix}/info/dir; then install-info --info-dir=%{_prefix}/info --remove liquidwar5; fi; fi; fi

%files
%defattr(-,root,root)
%{_prefix}/games/liquidwar5
%{_prefix}/games/liquidwar5-server
%{_prefix}/games/liquidwar5-mapgen
%{_prefix}/bin/liquidwar5
%{_prefix}/bin/liquidwar5-server
%{_prefix}/bin/liquidwar5-mapgen
%{_prefix}/share/games/liquidwar5/
%{_prefix}/share/doc/liquidwar5/
%{_prefix}/share/man/man6/liquidwar5.6*
%{_prefix}/share/man/man6/liquidwar5-server.6*
%{_prefix}/share/man/man6/liquidwar5-mapgen.6*
%{_prefix}/share/info/liquidwar5.info*
%{_prefix}/share/pixmaps/liquidwar5.xpm
%{_prefix}/share/applications/liquidwar5.desktop

%changelog

* Sat Nov 22 2025 Christian Mauduit <ufoot@ufoot.org>
- adapt to new Allegro 5 branch, call it liquidwar5
