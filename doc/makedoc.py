...
=======
>>>>>>> 4ce03a0 ([build] fix build issues)
    return result
...
class XMLToTeX(XMLToX):
    ...
    def start_file(self, title):
        self.write("\\chapter{" + self.translate(title, "text") + "}\n")

    def start_chap(self, title):
        self.write("\\section{" + self.translate(title, "text") + "}\n")

    def start_part(self, title):
        self.write("\\subsection{" + self.translate(title, "text") + "}\n")
...
=======
    ...
    def translate(self, data, tag):
        ...
        result = format_email_and_url(result)
        if tag == "code":
            result = " " * self.indent + result.replace("\n", "\n" + " " * self.indent)
>>>>>>> 4ce03a0 ([build] fix build issues)
        else:
